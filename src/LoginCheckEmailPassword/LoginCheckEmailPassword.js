...
class LoginCheckEmailPassword extends React.Component {
    constructor(props) {
        super(props);
            ...
            <center><Header/>
                <Card variant="outlined" sx={{ width: 720, backgroundColor: "white" }}>
                    <div className="col-md-6 col-md-offset-3">
                        ...
                        <h5><center>Check the link in the e-mail to reset your password.</center></h5>
                        <br></br>
...
const connectedLoginCheckEmailPassword = connect(mapState, actionCreators)(LoginCheckEmailPassword);
export { connectedLoginCheckEmailPassword as LoginCheckEmailPassword };