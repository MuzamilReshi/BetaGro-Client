                    ...
                    <div className="col-sm-8 col-sm-offset-2">
                        ...
                        <Router history={history}>
                            <Switch>
                                ...
                                <Route path="/logincheckemailpassword" component={LoginCheckEmailPassword} />
                                <Route path="/loginresetpasswordsuccess" component={LoginResetPasswordSuccess} />
                                <Route path="/loginresetpassword" component={LoginResetPassword} />
                                <Route path="/loginotpverification" component={LoginOTPVerification} />
                                <Route path="/loginfirsttime" component={LoginFirstTime} />
                                <Route path="/logincheckemailfirst" component={LoginCheckEmailFirst} />
